...
class FinishedTasksScreen extends Component {
    state = {
        ...
        return(
            <View style={styles.container}>
                ...
                <TasksList parentNavigation={this.props.navigation} 
                           tasks={this.props.tasks.finished}
                           removeTask={(item) => {
                ...
                <TouchableOpacity style={styles.floating} onPress={() => {
                    ...
                    tasks.finished.map((value, index) => {
                        value.type = 'deleted'
                        tasks.deleted.push(value)
                    })
                    tasks.finished = []
...
export default connect(state => ({tasks: state.tasks}))(FinishedTasksScreen)